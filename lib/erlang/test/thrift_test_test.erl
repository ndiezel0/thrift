    ...
    [
        ...
        {"Xtruct record",
            ?_assertMatch(
                ...
                thrift_test_thrift:struct_new('Xtruct', #{
                    string_thing => null,
                    byte_thing => null,
                    i32_thing => null,
                    i64_thing => null
        ...
        {"Xtruct2 record",
            ?_assertMatch(
                ...
                thrift_test_thrift:struct_new('Xtruct2', #{
                    byte_thing => null,
                    struct_thing => null,
                    i32_thing => null
                })
        ...
        {"Xtruct3 record",
            ?_assertMatch(
                ...
                thrift_test_thrift:struct_new('Xtruct3', #{
                    string_thing => null,
                    changed => null,
                    i32_thing => null,
                    i64_thing => null
        ...
        {"CrazyNesting record",
            ?_assertMatch(
                ...
                thrift_test_thrift:struct_new('CrazyNesting', #{
                    string_field => null,
                    set_field => null,
                    list_field => null,
                    binary_field => null
        ...
        {"Xception2 record",
            ?_assertMatch(
                ...
                thrift_test_thrift:struct_new('Xception2', #{
                    errorCode => null, struct_thing => null
                })
            )},
        {"EmptyStruct record",
            ?_assertMatch(
        ...
        {"VersioningTestV1 record",
            ?_assertMatch(
                ...
                thrift_test_thrift:struct_new('VersioningTestV1', #{
                    begin_in_both => null,
                    old_string => null,
                    end_in_both => null
                })
        ...
        {"VersioningTestV2 record",
            ?_assertMatch(
                ...
                thrift_test_thrift:struct_new('VersioningTestV2', #{
                    begin_in_both => null,
                    newint => null,
                    newbyte => null,
                    newshort => null,
        ...
        {"ListTypeVersioningV1 record",
            ?_assertMatch(
                ...
                thrift_test_thrift:struct_new('ListTypeVersioningV1', #{
                    myints => null, hello => null
                })
            )},
        {"ListTypeVersioningV2 record",
            ?_assertMatch(
                #{'$struct' := 'ListTypeVersioningV2', strings := null, hello := null},
                thrift_test_thrift:struct_new('ListTypeVersioningV2', #{
                    strings => null, hello => null
                })
            )},
        ...
        {"LargeDeltas record",
            ?_assertMatch(
                ...
                thrift_test_thrift:struct_new('LargeDeltas', #{
                    b1 => null,
                    b10 => null,
                    b100 => null,
                    check_true => null,
        ...
        {"NestedMixedx2 record",
            ?_assertMatch(
                ...
                thrift_test_thrift:struct_new('NestedMixedx2', #{
                    int_set_list => null,
                    map_int_strset => null,
                    map_int_strset_list => null
                })
