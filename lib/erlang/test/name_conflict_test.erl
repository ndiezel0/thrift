    ...
    [
        ...
        {"ClassAndProp record",
            ?_assertMatch(
                ...
                name_conflict_test_thrift:struct_new('ClassAndProp', #{
                    'ClassAndProp' => null,
                    'ClassAndProp_' => null,
                    'ClassAndProp__' => null,
                    'ClassAndProper' => null
        ...
        {"second_chance record",
            ?_assertMatch(
                ...
                name_conflict_test_thrift:struct_new(second_chance, #{
                    'SECOND_CHANCE' => null,
                    'SECOND_CHANCE_' => null,
                    'SECOND_CHANCE__' => null,
                    'SECOND_CHANCES' => null
        ...
        {"NOW_EAT_THIS record",
            ?_assertMatch(
                ...
                name_conflict_test_thrift:struct_new('NOW_EAT_THIS', #{
                    now_eat_this => null,
                    now_eat_this_ => null,
                    now_eat_this__ => null,
                    now_eat_this_and_this => null
        ...
        {"TheEdgeCase record",
            ?_assertMatch(
                ...
                name_conflict_test_thrift:struct_new('TheEdgeCase', #{
                    theEdgeCase => null,
                    theEdgeCase_ => null,
                    theEdgeCase__ => null,
                    'TheEdgeCase' => null,
        ...
        {"Nested record",
            ?_assertMatch(
                ...
                name_conflict_test_thrift:struct_new('Nested', #{
                    'ClassAndProp' => null,
                    second_chance => null,
                    'NOW_EAT_THIS' => null,
                    'TheEdgeCase' => null,
        ...
        {"Problem_ record",
            ?_assertMatch(
                ...
                name_conflict_test_thrift:struct_new('Problem_', #{
